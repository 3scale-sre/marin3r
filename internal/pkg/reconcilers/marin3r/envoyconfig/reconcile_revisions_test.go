...
import (
	...
	k8sutil "github.com/3scale-ops/marin3r/internal/pkg/util/k8s"
...
func TestRevisionReconciler_DesiredVersion(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields{context.TODO(), logr.Logger{}, nil, nil, nil, pointer.New("xxxx"), nil, nil, nil},
			"xxxx",
		},
	}
	for _, tt := range tests {
...
func TestRevisionReconciler_PublishedVersion(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields{context.TODO(), logr.Logger{}, nil, nil, nil, nil, pointer.New("xxxx"), nil, nil},
			"xxxx",
		},
	}
	for _, tt := range tests {
...
func TestRevisionReconciler_GetCacheState(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields{context.TODO(), logr.Logger{}, nil, nil, nil, nil, nil, pointer.New(marin3rv1alpha1.InSyncState), nil},
